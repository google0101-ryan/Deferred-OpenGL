...
bool DirShadowBuffer::SetupFramebuffer(int w, int h)
{
    ...
    glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, GL_DEPTH_COMPONENT32F, width, height, 5, 0, GL_DEPTH_COMPONENT, GL_FLOAT, NULL);
    ...
    glBindTexture(GL_TEXTURE_2D, 0);
    glFramebufferTexture3D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, depthBuffer, 0, 0);
